...
\begin{figure}[t]
	\begin{tikzpicture}
		\begin{groupplot}[height=25cm,group style={group size= 1 by 2}]
			...
			%% MULTIPLOT(ds,arity) SELECT input_file AS x, MIN(LOG(2, query_time_total)) AS y, MULTIPLOT
   ...
   \addlegendentry{ds=blocktree,arity=2};
   ...
   \addlegendentry{ds=blocktree,arity=32};
   ...
   \addlegendentry{ds=sampled\_scan\_512,arity=};
   ...
   \addlegendentry{ds=string,arity=};
		\end{groupplot}
	\end{tikzpicture}
...
\begin{figure}
   ...
   \addlegendentry{ds=blocktree,filetype=bt,arity=2,prefix\_suffix=0};
   ...
   \addlegendentry{ds=blocktree,filetype=bt,arity=32,prefix\_suffix=16};
   ...
   \addlegendentry{ds=sampled\_scan\_512,filetype=rp,arity=,prefix\_suffix=};
   ...
   \addlegendentry{ds=sampled\_scan\_512,filetype=seq,arity=,prefix\_suffix=};
   ...
   \addlegendentry{ds=string,filetype=plaintext,arity=,prefix\_suffix=};
...
\begin{figure}
	\begin{tikzpicture}
		\begin{groupplot}[height=25cm,group style={group size= 1 by 2}]
			...
			%% GROUP BY filetype, input_file, MULTIPLOT ORDER BY MULTIPLOT,x
   \addplot coordinates { (cere,10.8065) (coreutils,11.0478) (e\_coli,10.7731) (einstein\_de,10.9887) (einstein\_en,11.1261) (fib41,11.3443) (influenza,10.3783) (kernel,11.0967) (para,10.7245) (worldleaders,10.9144) };
   \addlegendentry{ds=blocktree,arity=2,prefix\_suffix=0};
   ...
   \addlegendentry{ds=blocktree,arity=32,prefix\_suffix=0};
...
\begin{figure}
   ...
   \addlegendentry{ds=lzend,filetype=lzend,arity=,prefix\_suffix=};

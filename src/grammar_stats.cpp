...
auto main(int argc, char **argv) -> int {
    ...
    std::cout << std::fixed << "RESULT file=" << file_name << " num_rules=" << num_rules << " size=" << size
              << " source_length=" << source_len << " avg_rule_len=" << avg_rule_len << " depth=" << depth
              << " avg_depth=" << avg_depth << std::endl;
}

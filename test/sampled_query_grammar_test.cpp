...
INSTANTIATE_TEST_SUITE_P(SampledScanQueryGrammarTests, SampledQueryGrammarTestFixture, ::testing::Values(
  TestInput("english.seq.r", 25)//TestInput("dblp.seq", 25), TestInput( "dna.seq", 25 )
                         ));
